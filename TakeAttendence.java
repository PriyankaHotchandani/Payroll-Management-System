...
public class TakeAttendence extends JFrame implements ActionListener{
    ...
    TakeAttendence(){
       //Grid Layout is used where there is division into columns and rows
       //The first paramter specifies the no. of rows, 2nd the no. of columns,
       //3rd and 4th specify distance between successive rows and columns respectively
