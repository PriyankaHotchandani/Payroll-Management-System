...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("payroll2im.jpg"));
        ...
        setJMenuBar(mb);
        JMenu m1 = new JMenu("Employee and Salary");
        ...
        JMenu rep =new JMenu("Attendance and payslip");
